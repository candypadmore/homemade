...
<div class="newsletters newsletters-management">
	...
	<p class="managementemail">
	    ...
	    <?php if (!empty($managementdelete)) : ?>
	    	<span class="managementdelete"><a class="newsletters_button btn btn-danger" onclick="if (!confirm('<?php _e('Are you sure you want to delete your account?', 'wp-mailinglist'); ?>')) { return false; }" href="<?php echo $deleteurl; ?>"><i class="fa fa-trash fa-fw"></i> <?php _e('Delete Account', 'wp-mailinglist'); ?></a></span>
	    <?php endif; ?>
	</p>
	...
	<div class="<?php echo $this -> pre; ?> newsletters">
		...
		<div role="tabpanel" id="managementtabs">
			...
			<ul class="nav nav-tabs" role="tablist">
				<?php if ($this -> get_option('managementshowsubscriptions') == "Y") : ?><li role="presentation" <?php if (empty($activeused)) : $activeused = true; echo 'class="active"'; endif; ?>><a aria-controls="current" role="tab" data-toggle="tab" href="#current"><?php _e('Current', 'wp-mailinglist'); ?></a></li><?php endif; ?>
				<?php if ($this -> get_option('managementallownewsubscribes') == "Y") : ?><li role="presentation" <?php if (empty($activeused)) : $activeused = true; echo 'class="active"'; endif; ?>><a aria-controls="subscribe" role="tab" data-toggle="tab" href="#subscribe"><?php _e('Subscribe', 'wp-mailinglist'); ?></a></li><?php endif; ?>
				<?php if ($this -> get_option('managementcustomfields') == "Y") : ?><li role="presentation" <?php if (empty($activeused)) : $activeused = true; echo 'class="active"'; endif; ?>><a aria-controls="profile" role="tab" data-toggle="tab" href="#profile"><?php _e('Profile', 'wp-mailinglist'); ?></a></li><?php endif; ?>
			...
			<div class="tab-content">
				<?php if ($this -> get_option('managementshowsubscriptions') == "Y") : ?>
				    <div role="tabpanel" class="tab-pane <?php if (empty($activeused)) : $activeused = true; echo 'active'; endif; ?>" id="current">
				...
				<?php endif; ?>
			   	...
			   	<?php if ($this -> get_option('managementallownewsubscribes') == "Y") : ?>    
			        <div role="tabpanel" class="tab-pane <?php if (empty($activeused)) : $activeused = true; echo 'active'; endif; ?>" id="subscribe">
			    ...
			    <?php if ($this -> get_option('managementcustomfields') == "Y") : ?>
			        <div role="tabpanel" class="tab-pane <?php if (empty($activeused)) : $activeused = true; echo 'active'; endif; ?>" id="profile">
						<?php
