...
<div class="wrap newsletters">
	...
	<form id="posts-filter" action="?page=<?php echo $this -> sections -> fields; ?>" method="post">
		...
		<p class="search-box">
			<input type="text" name="searchterm" id="post-search-input" class="search-input" value="<?php echo (empty($_POST['searchterm'])) ? esc_html($_GET[$this -> pre . 'searchterm']) : esc_html($_POST['searchterm']); ?>" />
