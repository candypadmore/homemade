	    	...
	    	<tbody>
	        	<tr>
	                ...
	                <td>
	                    ...
	                    <span class="howto"><?php _e('subject of the email to the subscribers.', 'wp-mailinglist'); ?></span>
	                </td>
	            </tr>
	            <tr>
	                	...
	                	<?php if ($mailinglists = $Mailinglist -> select(true)) : ?>
	                    	...
	                    	<div class="scroll-list">
	                        	<?php foreach ($mailinglists as $list_id => $list_title) : ?>
	                            	<label><input <?php echo (!empty($lists) && in_array($list_id, $lists)) ? 'checked="checked"' : ''; ?> type="checkbox" name="lists[]" value="<?php echo $list_id; ?>" id="lists_<?php echo $list_id; ?>" /> <?php echo $list_title; ?> (<?php echo $SubscribersList -> count(array('list_id' => $list_id, 'active' => "Y")); ?> <?php _e('active', 'wp-mailinglist'); ?>)</label><br/>
	                            <?php endforeach; ?>
	                        </div>
	                    <?php else : ?>
	        	...
	        	<tbody>
	        		<tr>
		            	...
		            	<td>
		            		...
		            		<input type="text" name="startdate" value="<?php echo esc_attr(stripslashes(date("Y-m-d H:i:s", strtotime($startdate)))); ?>" id="startdate" /> <strong><?php _e('Current Date/Time:', 'wp-mailinglist'); ?> <?php echo $Html -> gen_date("Y-m-d H:i:s"); ?></strong>
