		...
		<tbody>
            ...
            <?php if (!empty($mailinglist -> redirect)) : ?>
            	<tr class="<?php echo $class = (empty($class)) ? 'alternate' : ''; ?>">
            		...
            		<td><?php echo '<a href="' . esc_attr(stripslashes(__($mailinglist -> redirect))) . '" target="_blank">' . __($mailinglist -> redirect) . '</a>'; ?></td>
            	</tr>
            <?php endif; ?>
            <?php if (!empty($mailinglist -> subredirect)) : ?>
            	<tr class="<?php echo $class = (empty($class)) ? 'alternate' : ''; ?>">
            		<th><?php _e('Subscribe Redirect URL', 'wp-mailinglist'); ?></th>
            		<td><?php echo '<a href="' . esc_attr(stripslashes(__($mailinglist -> subredirect))) . '" target="_blank">' . __($mailinglist -> subredirect) . '</a>'; ?></td>
            	</tr>
            <?php endif; ?>
			<tr class="<?php echo $class = (empty($class)) ? 'alternate' : ''; ?>">
