	                ...
	                <td>
		                <?php if ($this -> language_do()) : ?>
							<div id="mailinglist-subredirect-tabs">
								<ul>
									<?php foreach ($languages as $language) : ?>
										<li><a href="#mailinglist-subredirect-tabs-<?php echo $language; ?>"><?php echo $this -> language_flag($language); ?></a></li>
									<?php endforeach; ?>
								</ul>
								<?php foreach ($languages as $language) : ?>
									<div id="mailinglist-subredirect-tabs-<?php echo $language; ?>">
										<input placeholder="<?php echo esc_attr(stripslashes(__('https://domain.com/custom/url/to/go/to/', 'wp-mailinglist'))); ?>" type="text" class="widefat" name="Mailinglist[subredirect][<?php echo $language; ?>]" value="<?php echo esc_attr(stripslashes($this -> language_use($language, $Mailinglist -> data -> subredirect))); ?>" id="Mailinglist_subredirect_<?php echo $language; ?>" />
									</div>
								<?php endforeach; ?>
							</div>
                	...
                	<td>
	                	<?php if ($this -> language_do()) : ?>
							<div id="mailinglist-redirect-tabs">
								<ul>
									<?php foreach ($languages as $language) : ?>
										<li><a href="#mailinglist-redirect-tabs-<?php echo $language; ?>"><?php echo $this -> language_flag($language); ?></a></li>
									<?php endforeach; ?>
								</ul>
								<?php foreach ($languages as $language) : ?>
									<div id="mailinglist-redirect-tabs-<?php echo $language; ?>">
										<input placeholder="<?php echo esc_attr(stripslashes(__('https://domain.com/custom/url/to/go/to/', 'wp-mailinglist'))); ?>" type="text" class="widefat" name="Mailinglist[redirect][<?php echo $language; ?>]" value="<?php echo esc_attr(stripslashes($this -> language_use($language, $Mailinglist -> data -> redirect))); ?>" id="Mailinglist_redirect_<?php echo $language; ?>" />
									</div>
								<?php endforeach; ?>
							</div>
