	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<?php else : ?>
            		<input onkeyup="if (jQuery('#updatereturnpath').attr('checked')) { jQuery('#bounceemail').val(jQuery(this).val()); }" class="widefat" type="text" id="smtpfrom" name="smtpfrom" value="<?php echo esc_attr(stripslashes($this -> get_option('smtpfrom'))); ?>" />
