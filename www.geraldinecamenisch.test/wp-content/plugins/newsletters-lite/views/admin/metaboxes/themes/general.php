...
<h3><?php _e('Permanent Options', 'wp-mailinglist'); ?></h3>
<p class="howto"><?php _e('These options are used everytime the template is used.', 'wp-mailinglist'); ?></p>
<table class="form-table">
	<tbody>
		<tr>
			<th><label for="Theme_themestylesheet"><?php _e('Include WordPress Theme Stylesheet', 'wp-mailinglist'); ?></label>
			<td>
				<label><input <?php checked($Theme -> data -> themestylesheet, 1, true); ?> type="checkbox" value="1" name="Theme[themestylesheet]" id="Theme_themestylesheet" /> <?php _e('Yes, include the WordPress theme stylesheet in this template.', 'wp-mailinglist'); ?></label>
			</td>
		</tr>
		<tr>
...
<h3><?php _e('Once-Off Options', 'wp-mailinglist'); ?></h3>
<p class="howto"><?php _e('These options are used once when you save this template and not again.', 'wp-mailinglist'); ?></p>
<table class="form-table">
	<tbody>
    	<tr>
