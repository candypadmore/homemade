...
$customtext = (!empty($defaulttexton)) ? $defaulttextversion : $_POST['customtext'];
...
<div id="multimime_div" style="display:<?php echo (!empty($_POST['customtext']) || !empty($defaulttexton)) ? 'block' : 'none'; ?>;">
	<textarea name="customtext" id="customtext" rows="6" cols="100%" class="widefat"><?php echo esc_attr(strip_tags(stripslashes($customtext))); ?></textarea>
