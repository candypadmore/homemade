<div id="newsletters_forms_field_<?php echo $field -> id; ?>" class="postbox ">	
	...
	<div class="newsletters_delete_handle"><a href="" onclick="if (confirm('<?php _e('Are you sure you want to delete this field?', 'wp-mailinglist'); ?>')) { newsletters_forms_field_delete('<?php echo $field -> id; ?>'); } return false;"><i class="fa fa-times fa-fw"></i></a></div>
