...
<div class="wrap newsletters">	
	...
	<?php /*<?php echo admin_url('admin.php?page=' . $this -> sections -> forms . '&amp;method=settings&amp;id=' . $form -> id); ?>*/ ?>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<input type="hidden" style="width:45px;" name="styling[formpadding]" value="<?php echo esc_attr(stripslashes($styling['formpadding'])); ?>" id="styling_formpadding" />
										<div class="slider" data-input="styling_formpadding" data-min="0" data-max="100" data-meas="px" data-value="<?php echo esc_attr(stripslashes($styling['formpadding'])); ?>"></div>
									</td>
								</tr>
								<tr>
									<th><label for="styling_formtextcolor"><?php _e('Text Color', 'wp-mailinglist'); ?></label></th>
									<td>
										<input type="text" class="color-picker" name="styling[formtextcolor]" value="<?php echo esc_attr(stripslashes($styling['formtextcolor'])); ?>" id="styling_formtextcolor" />
									</td>
								</tr>
								<tr>
							...
							<table class="form-table">
								<tbody>
									<tr>
										...
										<td>
											<input type="text" class="color-picker" name="styling[fieldcaptioncolor]" value="<?php echo esc_attr(stripslashes($styling['fieldcaptioncolor'])); ?>" id="styling_fieldcaptioncolor" />
										</td>
									</tr>
								</tbody>
							</table>
							...
							<table class="form-table">
								<tbody>
									<tr>
										...
										<td>
											<input type="text" class="color-picker" name="styling[fielderrorcolor]" value="<?php echo esc_attr(stripslashes($styling['fielderrorcolor'])); ?>" id="styling_fielderrorcolor" />
										</td>
									</tr>
								</tbody>
							</table>
...
jQuery(document).ready(function() {
	...
	jQuery('#newsletters-forms-settings-styling-tabs').tabs();
