...
<div class="newsletters">
	<p>
		<a class="btn btn-default" href="<?php echo esc_attr(stripslashes($this -> get_managementpost(true, false, false))); ?>"><?php _e('&laquo; Back to Manage Subscriptions', 'wp-mailinglist'); ?></a>	
	</p>
	
	<h2><?php _e('Paid Subscription', 'wp-mailinglist'); ?></h2>
	<p>
		<?php echo sprintf(__('You are paying for your subscription to %s.', 'wp-mailinglist'), __($mailinglist -> title)); ?><br/>
