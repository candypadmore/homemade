		...
		<?php if (!empty($emails)) : ?>
			<?php foreach ($emails as $email) : ?>
				<item>
					...
					<link><?php echo $Html -> retainquery('newsletters_method=newsletter&id=' . $email -> id . '&fromfeed=1', home_url()); ?></link>
					<guid><?php echo $Html -> retainquery('newsletters_method=newsletter&id=' . $email -> id . '&fromfeed=1', home_url()); ?></guid>
